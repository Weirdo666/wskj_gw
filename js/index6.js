...
(function () {
    ...
    var e = "v1.5.0 (2016.01.25)", t = ["360.cn", "so.com", "leidian.com"], n = function (r, i) {
        var s;
        (function () {
            s = !0;
            try {
        ...
        var o = document, u = navigator, a = r.screen, f = s ? "" : document.domain.toLowerCase(), l = u.userAgent.toLowerCase(), c = {
            trim: function (e) {
            ...
            getColorDepth: function () {
                ...
                var e = [u.appName, u.version, u.language || u.browserLanguage, u.platform, u.userAgent, a.width, "x", a.height, a.colorDepth, o.referrer].join(""), t = e.length, n = r.history.length;
                while (n)e += n-- ^ t++;
                return (Math.round(Math.random() * 2147483647) ^ m.hash(e)) * 2147483647
            }, getSid: function () {
                var e = "__sid", t = v.get(e);
                t || (t = [m.hash(s ? "" : o.domain), m.guid(), +(new Date) + Math.random()].join("."));
                var n = {expires: (m._activeTime || 30) * 60 * 1e3, path: "/"};
                ...
                var e = "monitor_count", t = v.get(e);
                return t = (parseInt(t) || 0) + 1, v.set(e, t, {expires: 864e5, path: "/"}), function () {
                    return t
                }
            ...
            getBase: function () {
                ...
                e = p.fix(e || event);
                var t = e.target, n = t.tagName, r = m.getContainerId(t);
                if (!t.type || t.type != "submit" && t.type != "button") {
                    if (n == "AREA")return {f: m.getHref(t), c: "area:" + t.parentNode.name, cId: r};
                    var f, l;
                ...
                } else s = {f: m.getHref(t), c: m.getText(t), cId: r};
                return s
        ...
        }, y = {trackUrl: null, clickUrl: null, areaIds: null}, b = function (e) {
            return document.getElementById(e)
        };
        return {
            version: e, util: m, data: g, config: y, sendLog: function () {
                return r.__qihoo_monitor_imgs = {}, function (e) {
                    var t = "log_" + +(new Date), n = r.__qihoo_monitor_imgs[t] = new Image;
                ...
                var n = this, r = [];
                e = e || 10, t = t || 5;
                var i = 0, s = function (o) {
                    clearTimeout(i);
                    if (o || r.length > e) {
                        if (!r.length)return;
                        n.log({pos: r.join(","), sr: m.getScreenSize()}, "clickHeatMap"), r = [];
                        return
                    }
